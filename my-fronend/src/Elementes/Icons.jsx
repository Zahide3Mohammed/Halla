...
export const IconRocket = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84 1.68-2.6 1.68-2.6-1.52.4-3.79-.84-4.68-1.4Z" />
        <path d="M15.18 10.59 20 6.64a2.25 2.25 0 0 0-1.78-3.64H6.64A2.25 2.25 0 0 0 3 6.64l3.95 4.82Z" />
...
export const IconLightbulb = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 6a6 6 0 1 0 4.24 10.24" />
    </svg>
);
